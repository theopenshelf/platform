...
export class MockCategoriesService implements CategoriesService {
  ...
  public static BEAUTY_HEALTH: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'beauty health',
    color: '#e17ac4',
    template: 'Beauty & Health Template',
    icon: '@tui.heart',
  };
  public static SPORTS_OUTDOORS: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'sports outdoors',
    color: '#2a7f3d',
    template: 'Sports & Outdoors Template',
    icon: '@tui.bike',
  };
  public static CAMPING: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'camping',
    color: '#4f9c38',
    template: 'Camping Template',
    icon: '@tui.tent',
  };
  public static GARDENING: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'gardening',
    color: '#4ca24c',
    template: 'Gardening Template',
    icon: '@tui.flower',
  };
  public static VEHICLE: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'vehicle',
    color: '#019cdb',
  ...
  public static KIDS: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'kids',
    color: '#e0b100',
    template: 'Kids Template',
    icon: '@tui.baby',
  };
  public static EVENTS: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'events',
    color: '#e7315c',
  ...
  public static MULTIMEDIA: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'multimedia',
    color: '#1e9ee7',
  ...
  public static TRAVEL: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'travel',
    color: '#f09830',
    template: 'Travel Template',
    icon: '@tui.train-front',
  };
  public static SAFETY: UICategory = {
    id: MockCategoriesService.index++ + '',
    name: 'safety',
    color: '#f57d2b',
